# My personal awesome software list.
...
* [tig](https://jonas.github.io/tig/): Text interface for Git repositories. ![OSS][oss] ![Linux][linux] ![Mac][mac] ![Windows][windows] ![CLI][cli]
...
* [Homebrew](https://brew.sh/): The Missing Package Manager for macOS (or Linux). ![Linux][linux] ![Mac][mac]
...
* [YAZIO](https://www.yazio.com/): Welcome to a healthier life. ![iOS][ios] ![Android][android]

### Multimedia.
* [AntennaPod](https://github.com/antennapod/AntennaPod): A podcast manager for Android. ![OSS][oss] ![Android][android]
* [detektor.fm](https://detektor.fm/empfang): Listen to detektor.fm radio. ![iOS][ios] ![Android][android]
* [Halide](https://halide.cam/): Premium RAW & Manual. ![iOS][ios]
* [IP Cam Viewer](http://hit-mob.com/): Remotely view, control and record your IP camera, webcam, DVR and NVR. ![iOS][ios] ![Android][android]
* [NewPipe](https://github.com/TeamNewPipe/NewPipe/): A libre lightweight streaming front-end for Android. ![Android][android] ![OSS][oss]
* [Pocket Casts](https://www.pocketcasts.com/): Powerful podcast player. ![iOS][ios] ![Android][android]
* [Reeder 4](https://www.reederapp.com/): News Reader. ![iOS][ios]
* [Triode](https://triode.app/): Enjoy all of your favorite Internet radio stations wherever you go. ![iOS][ios]
* [Pixelmator](https://www.pixelmator.com/ios/): Powerful, full-featured image editor. ![iOS][ios]
* [Procreate](https://procreate.art/): Sketch, paint, create. ![iOS][ios]
* [VLC](https://www.videolan.org/vlc/download-ios.html): Play all your movies and shows in most formats directly without conversion. ![iOS][ios]
* [Die MausApp](https://www.wdrmaus.de/extras/mausapp.php5): Interaktiv die MausWelt entdecken. ![iOS][ios] ![Android][android]

### News & Messaging.
* [Signal](https://signal.org/): Say "hello" to privacy. ![iOS][ios] ![Android][android] ![OSS][oss]
* [Threema](https://threema.ch/): Seriously secure messaging. ![iOS][ios] ![Android][android]
* [Toot!](https://apps.apple.com/app/toot/id1229021451?ls=1): Client for the Mastodon social network. ![iOS][ios]
* [Tweetbot](https://tapbots.com/tweetbot/): Award-winning Twitter client for iOS and the Mac. ![iOS][ios]
* [Twitterrific](https://twitterrific.com/ios): Award-winning, elegant Twitter client that’s easy to understand and a delight to use. ![iOS][ios]
...
* [MoneyStats](http://www.ttdeveloped.com/_moneystats/moneystats_index.php): Track your expenses & income. ![iOS][ios]
* [NINA](https://www.bbk.bund.de/DE/NINA/Warn-App_NINA.html): Warnt Sie deutschlandweit vor Gefahren, auf Wunsch auch für Ihren aktuellen Standort. ![iOS][ios] ![Android][android]
* [ParcelTrack](https://www.parceltrack.de/): Track all carriers in one app. ![iOS][ios] ![Android][android]
